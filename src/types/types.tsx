...
export type FetchedMenuItem = { productId: string; name: string; price: number; stockQty: number; safetyStock: number; soldOutStatus: string; categoryCode?: string; categoryName?: string; taxType?: "TAXABLE" | "TAX_EXEMPT"; sortOrder?: number; categorySortOrder?: number };
